...
class DailyRecord(Base):
    ...
    gang_boss_fights: Mapped[int] = mapped_column(Integer, default=0)
    gang_challenge_books: Mapped[int] = mapped_column(Integer, default=0)
    tower_revive: Mapped[int] = mapped_column(Integer, default=0)
    flowers_remaining: Mapped[int] = mapped_column(Integer, default=0)
    ...
    museum_trades: Mapped[int] = mapped_column(Integer, default=0)
